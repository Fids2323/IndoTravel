...
var _controlJs = require("./modules/control.js");
var _controlJsDefault = parcelHelpers.interopDefault(_controlJs);
var _accJs = require("./modules/acc.js");
var _menuControlJs = require("./modules/menuControl.js");
var _flyJs = require("./modules/fly.js");
var _getDataJSONJs = require("./modules/getDataJSON.js");
var _fetchJs = require("./modules/fetch.js");
var _formValidateJs = require("./modules/form-validate.js");
var _sliderJs = require("./modules/slider.js");
const date = new Date(Date.UTC(2023, 1, 24, 20, 20));
const init = ()=>{
    (0, _timerJsDefault.default)((0, _controlJsDefault.default)(date));
};
init();

},{"./modules/timer.js":"9iEfi","./modules/control.js":"zfhsF","./modules/acc.js":"d8Sae","./modules/menuControl.js":"57tTM","./modules/fly.js":"37Tar","./modules/getDataJSON.js":"abaFN","./modules/fetch.js":"cughM","./modules/form-validate.js":"2vxMA","./modules/slider.js":"6k0CU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9iEfi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const timer = (deadline)=>{
    ...
    const renderPhrase = (number)=>{
        ...
        if (lastOne === 0) return arrayTwo;
        if (number > 4 && number < 15) return arrayTwo;
        if (lastOne === 1) return arrayThree;
        if ([
            2,
            3,
            4
        ].indexOf(lastOne) >= 0) return arrayOne;
        return arrayTwo;
    };
    const start = ()=>{
...
exports.default = setDeadline;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8Sae":[function(require,module,exports) {
...
buttons.forEach((btn, index)=>{
    btn.addEventListener("click", ()=>{
        for(let i = 0; i < items.length; i++)if (index === i) {
...
},{}],"57tTM":[function(require,module,exports) {
...
const openBurgerMenu = ()=>{
    ...
    setTimeout(function changeOpacity() {
        ...
        if (opacity < 0.9) setTimeout(changeOpacity, 100);
    });
};
const closeBurgerMenu = ()=>{
    ...
    setTimeout(function changeOpacity() {
        opacity -= 0.1;
        menu.style.opacity = opacity;
        if (opacity >= 0) setTimeout(changeOpacity, 100);
    });
};
// Toggle the "header__menu_active"
menuButton.addEventListener("click", ()=>{
    if (menu.classList.contains("header__menu_active")) requestAnimationFrame(closeBurgerMenu);
    else requestAnimationFrame(openBurgerMenu);
...
},{}],"37Tar":[function(require,module,exports) {
...
if (docEL.clientWidth >= 758) {
  ...
  `;
    ...
    const calcPositionFly = ()=>{
        ...
        if (scroll > up) fly.style.transform = "rotate(-180deg)";
        else fly.style.transform = "rotate(0deg)";
        scroll = up;
    };
    let scroll = 0;
...
},{}],"abaFN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _renderPhraseJs = require("./utils/renderPhrase.js");
var _renderPhraseJsDefault = parcelHelpers.interopDefault(_renderPhraseJs);
var _renderDateJs = require("./utils/renderDate.js");
var _renderDateJsDefault = parcelHelpers.interopDefault(_renderDateJs);
...
reservationDate.addEventListener("change", ()=>{
    ...
    reservationDataText.textContent = `${(0, _renderDateJsDefault.default)(date)}`;
});
reservationPeople.addEventListener("change", ({ target  })=>{
    ...
    reservationDataText.textContent += `, ${target.value} ${(0, _renderPhraseJsDefault.default)(+target.value)}`;
    //total price
    reservationPriceText.textContent = "";
    const date = reservationDate.value;
    const currentData = data.filter((item)=>item.date === date)[0];
...
},{"./utils/renderPhrase.js":"d6Ngs","./utils/renderDate.js":"bZHOZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d6Ngs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const renderPhrase = (number)=>{
    const lastOne = Number(number.toString().slice(-1));
    ...
    if ([
        ...
        3,
        4
    ].indexOf(lastOne) >= 0) return "человека";
    return "человек";
};
exports.default = renderPhrase;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bZHOZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cughM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
form.addEventListener("submit", async (e)=>{
    ...
    if (words.length >= 3) {
        ...
        const result = await fetchRequest(URL, {
            ...
            callback: (0, _modalJsDefault.default),
            headers: {
...
},{"./modal.js":"9kYVH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9kYVH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _loadStyleModalJs = require("./loadStyleModal.js");
var _loadStyleModalJsDefault = parcelHelpers.interopDefault(_loadStyleModalJs);
var _renderPhraseJs = require("./utils/renderPhrase.js");
var _renderPhraseJsDefault = parcelHelpers.interopDefault(_renderPhraseJs);
var _renderDateJs = require("./utils/renderDate.js");
var _renderDateJsDefault = parcelHelpers.interopDefault(_renderDateJs);
const showModal = async (err, data)=>{
    await (0, _loadStyleModalJsDefault.default)("css/modal.css");
    ...
    modalTextReservation.textContent = `Бронирование путешествия в Индию на ${data.people} ${(0, _renderPhraseJsDefault.default)(data.people)}`;
    modalTextDate.classList.add("modal__text");
    modalTextDate.textContent = `В даты: ${(0, _renderDateJsDefault.default)(data.date)}`;
...
},{"./loadStyleModal.js":"5x8Af","./utils/renderPhrase.js":"d6Ngs","./utils/renderDate.js":"bZHOZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5x8Af":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2vxMA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _inputmaskEs6Js = require("../../node_modules/inputmask/dist/inputmask.es6.js");
var _inputmaskEs6JsDefault = parcelHelpers.interopDefault(_inputmaskEs6Js);
var _justValidateEsJs = require("../../node_modules/just-validate/dist/just-validate.es.js");
var _justValidateEsJsDefault = parcelHelpers.interopDefault(_justValidateEsJs);
//Mask
const inputTel = document.querySelector("#reservation__phone");
const telMask = new (0, _inputmaskEs6JsDefault.default)("+7 (999)-999-99-99");
telMask.mask(inputTel);
//Validate form
const justValidate = new (0, _justValidateEsJsDefault.default)(".reservation__form");
justValidate.addField("#reservation__name", [
    {
        rule: "required",
...
},{"../../node_modules/inputmask/dist/inputmask.es6.js":"kGyUA","../../node_modules/just-validate/dist/just-validate.es.js":"gcCDD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kGyUA":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _inputmaskJs = require("./inputmask.js");
const inputmask = window.Inputmask;
window.Inputmask = undefined;
exports.default = inputmask;

},{"./inputmask.js":"gyYno","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gyYno":[function(require,module,exports) {
/*!
 * dist/inputmask
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6k0CU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
console.log("sd");
swiperWrapper.classList.add("swiper-wrapper"); //const swiper = new Swiper(...);

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","swiper/swiper-bundle":"gXrCf"}],"gXrCf":[function(require,module,exports) {
/**
 * Swiper 9.1.0
 ...
 */ (function(global, factory) {
    ...
    function slideToLoop(index, speed, runCallbacks, internal) {
        ...
        if (swiper.params.loop) {
            ...
            else newIndex = swiper.getSlideIndex(swiper.slides.filter((slideEl)=>slideEl.getAttribute("data-swiper-slide-index") * 1 === newIndex)[0]);
        }
    ...
    function loopFix(_temp) {
        ...
        if (typeof activeSlideIndex === "undefined") activeSlideIndex = swiper.getSlideIndex(swiper.slides.filter((el)=>el.classList.contains("swiper-slide-active"))[0]);
    ...
    function HashNavigation(_ref) {
        ...
        const setHash = ()=>{
            ...
            if (swiper.params.hashNavigation.replaceState && window1.history && window1.history.replaceState) {
                window1.history.replaceState(null, null, `#${swiper.slides[swiper.activeIndex].getAttribute("data-hash")}` || "");
                emit("hashSet");
            } else {
...
},{}]},["lFH2R","2OpUZ"], "2OpUZ", "parcelRequireb47b")
