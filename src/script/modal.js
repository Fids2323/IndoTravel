...
import renderPhrase from "./renderPhrase.js";
...
const showModal = async (err, data) => {
  ...
  modalTextReservation.textContent = `Бронирование путешествия в Индию на ${
    data.people
  } ${renderPhrase(data.people)}`;
